...
export const VERTICALS = [
  {
    slug: 'automotive',
    name: 'Automotive',
    description: 'Car dealerships, workshops, and automotive businesses.',
    status: 'available',
  },
  {
    slug: 'fnb',
  ...
  },
  {
    slug: 'solar',
    name: 'Solar',
    description: 'Solar panel installers and renewable energy.',
    status: 'coming_soon',
  },
  {
    slug: 'property',
    name: 'Property',
    description: 'Real estate agents and property developers.',
    status: 'coming_soon',
  },
  {
    slug: 'takaful',
    name: 'Takaful',
    description: 'Islamic insurance and financial services.',
    status: 'coming_soon',
  },
];
